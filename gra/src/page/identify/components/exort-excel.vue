<template>
    <div class="fillcontain">
        ...
        <div class="table_container">
            ...
            <addDialog  v-if="addDialog.show" :isShow="addDialog.show" :dialogRow="addDialog.dialogRow"  @getFundList="getMoneyList"  @closeDialog="hideaddDialog"></addDialog>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
                  handleDownload() {
                    ...
                    const tHeader = ['用户姓名', '籍贯', '投资时间', '收支类型', '收入', '支出', '账户现金', '操作']
                    const filterVal = ['用户姓名', '籍贯', '投资时间', '收支类型', '收入', '支出', '账户现金', '操作']
