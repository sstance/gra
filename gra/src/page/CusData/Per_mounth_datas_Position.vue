<template>
    <div class="fillcontain">
        <div class="fillcontainer" ref="fillcontainer">
           <div id="Per_mounth_datas_Position" class="echartsPosition"></div> 
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            initChart() {
                this.chart = echarts.init(document.getElementById('Per_mounth_datas_Position'));
                const data = {};
                (function() {
                    const xAxisData = [];
                    const seriesIncome = [];
                    ...
                    for (let i = 1; i < 13; i++) {
                       seriesIncome.push(Math.round(Math.random()*20));
                       seriesPay.push(Math.round(Math.random()*10));
                       seriesaverage.push(Math.round(Math.random()*10));
                    }
